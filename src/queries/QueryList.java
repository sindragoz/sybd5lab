...
import containers.Container1stQuery;
import containers.Container2ndQuery;
import containers.Containers3rdQuery;
...
public class QueryList {
    ...
    public List<IEntity> query1() throws SQLException{
        ...
        try {
            ...
            while(rs.next()){
                Container1stQuery c = new Container1stQuery();
    ...
    public List<IEntity> query2() throws SQLException{
       List<IEntity> queryres = null;
        try {
            ...
            ResultSet rs = dbManager.executeQuery(query);
            while(rs.next()){
                Container2ndQuery c = new Container2ndQuery();
                c.setAmount(rs.getInt("amount"));
                c.setReason(rs.getString("reason"));
                c.setType(rs.getInt("ctype"));
    ...
    public List<IEntity> query3() throws SQLException{
        ...
        try {
            ...
            ResultSet rs = dbManager.executeQuery(query);
            while(rs.next()){
                Containers3rdQuery c = new Containers3rdQuery();
                c.setAmount(rs.getInt("amount"));
